...
\usepackage[total={180mm,250mm},left=15mm,top=20mm]{geometry}
...
\begin{document}
\title{Typografie a publikování \\ {\large1. projekt}}
...
\begin{quotation}
Čím více druhů, \textbf{\textit{řezů}}, velikostí, barev písma a \textsf{jiných efektů} použijeme, tím \textit{profesionálněji} bude dokument vypadat. Čtenář tím {\tiny bude} vždy \textbf{\huge nadšen!}
\end{quotation}
...
\section{Závěr}
\label{5}
Tento dokument schválně obsahuje několik typografických prohřešků. Sekce \hyperref[2]{2} a \hyperref[3]{3} obsahují typografické chyby. V kontextu celého textu je jistě snadno najdete. Je dobré znát možnosti \LaTeX u, ale je také nutné vědět, kdy je nepoužít.
